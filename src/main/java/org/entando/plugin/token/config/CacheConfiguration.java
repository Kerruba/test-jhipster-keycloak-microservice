...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(org.entando.plugin.token.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(org.entando.plugin.token.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
